...
private:
    ...
    std::list<CacheController*> m_l2CacheCtrl;
    ...
    // setup4
    Bus* l2_llc_bus = nullptr;
    Bus* llc_dram_bus = nullptr;
    std::list<DirectInterconnect*> l1_l2_direct_bus_list;

    // setup5
    Bus* l1_l2_bus = nullptr;
    std::list<Bus*> l1_l2_bus_list;

    // setup6
    Bus* l2_l2_bus = nullptr;
    std::list<DirectInterconnect*> l2_llc_direct_bus_list;
...
public:
    ...
    void setup4(MCoreSimProjectXml projectXmlCfg);
    void setup5(MCoreSimProjectXml projectXmlCfg);
    void setup6(MCoreSimProjectXml projectXmlCfg);
