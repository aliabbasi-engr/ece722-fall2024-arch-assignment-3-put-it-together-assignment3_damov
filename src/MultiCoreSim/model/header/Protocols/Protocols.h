...
// #include "Pendulum.h"
#include "L1MSIProtocol.h"
#include "L2MSIProtocol.h"
...
namespace ns3
{
    ...
    public:
        ...
        static CoherenceProtocolHandler* getNewProtocol(CohProtType pType, CacheDataHandler *cache, const string &fsm_path, int core_id, int shared_mem_id)
        {
            ...
            case CohProtType::L1_MSI:
                return new L1MSIProtocol(cache, fsm_path, core_id, shared_mem_id);
            case CohProtType::L2_MSI:
                return new L2MSIProtocol(cache, fsm_path, core_id, shared_mem_id);
